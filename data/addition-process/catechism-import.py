...
for p in range(624, 626): PARA_TO_PAGE[p] = 162   # 624–625
PARA_TO_PAGE[626] = "162-163"
for p in range(627, 631): PARA_TO_PAGE[p] = 163   # 627–630
for p in range(631, 634): PARA_TO_PAGE[p] = 164   # 631–633
for p in range(634, 638): PARA_TO_PAGE[p] = 165   # 634–637
for p in range(638, 640): PARA_TO_PAGE[p] = 166   # 638–639
PARA_TO_PAGE[640] = "166-167"
for p in range(641, 643): PARA_TO_PAGE[p] = 167   # 641–642
PARA_TO_PAGE[643] = "167-168"
for p in range(644, 646): PARA_TO_PAGE[p] = 168   # 644–645
PARA_TO_PAGE[646] = "168-169"
for p in range(647, 650): PARA_TO_PAGE[p] = 169   # 647–649
for p in range(650, 654): PARA_TO_PAGE[p] = 170   # 650–653
PARA_TO_PAGE[654] = "170-171"
for p in range(655, 659): PARA_TO_PAGE[p] = 171   # 655–658
for p in range(659, 662): PARA_TO_PAGE[p] = 172   # 659–661
for p in range(662, 667): PARA_TO_PAGE[p] = 173   # 662–666
PARA_TO_PAGE[667] = 174                            # 667
for p in range(668, 670): PARA_TO_PAGE[p] = 174   # 668–669
for p in range(670, 673): PARA_TO_PAGE[p] = 175   # 670–672
for p in range(673, 676): PARA_TO_PAGE[p] = 176   # 673–675
for p in range(676, 679): PARA_TO_PAGE[p] = 177   # 676–678
PARA_TO_PAGE[679] = "177-178"                      # 679
for p in range(683, 685): PARA_TO_PAGE[p] = 179   # 683–684
for p in range(685, 688): PARA_TO_PAGE[p] = 180   # 685–687
PARA_TO_PAGE[688] = "180-181"                      # 688
PARA_TO_PAGE[689] = 181                            # 689
PARA_TO_PAGE[690] = "181-182"                      # 690
for p in range(691, 693): PARA_TO_PAGE[p] = 182   # 691–692
for p in range(693, 696): PARA_TO_PAGE[p] = 183   # 693–695
for p in range(696, 698): PARA_TO_PAGE[p] = 184   # 696–697
for p in range(698, 702): PARA_TO_PAGE[p] = 185   # 698–701
for p in range(702, 705): PARA_TO_PAGE[p] = 186   # 702–704
PARA_TO_PAGE[705] = "186-187"                      # 705
for p in range(706, 709): PARA_TO_PAGE[p] = 187   # 706–708
PARA_TO_PAGE[709] = "187-188"                      # 709
for p in range(710, 712): PARA_TO_PAGE[p] = 188   # 710–711
PARA_TO_PAGE[712] = "188-189"                      # 712
for p in range(713, 717): PARA_TO_PAGE[p] = 189   # 713–716
